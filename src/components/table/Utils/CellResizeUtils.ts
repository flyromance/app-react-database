...
export const isCellResizeShown = (
  isResizable?: boolean,
  columnResizing?: boolean
): boolean => !!(isResizable !== false && (columnResizing || isResizable));
...
export const isNumberWidth = (width: any): boolean =>
...
export const headCellDispatchWrapper: (
  setWidth: any,
  dispatch: DispatchFunc
) => DispatchFunc = (setWidth, dispatch) => (action) => {
